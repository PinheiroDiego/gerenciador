...
$consulta = "UPDATE quemsomos SET primeirotitulo='$primeirotitulo', subtitulo='$subtitulo', segundotitulo='$segundotitulo', texto='$texto'  WHERE id='1' ";
...
if (!$ligacao->query($consulta)) {
    ...
    echo "<script>alert('Atualizado com sucesso');window.location='../quemsomos'</script>"; 
